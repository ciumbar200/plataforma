...
const BlogPage: React.FC<BlogPageProps> = ({ posts, onHomeClick, onLoginClick, onRegisterClick, onOwnersClick, onAboutClick, onPrivacyClick, onTermsClick, onContactClick }) => {
