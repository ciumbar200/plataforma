...
const PrivacyPolicyPage: React.FC<PageProps> = ({ onHomeClick, onLoginClick, onRegisterClick, onOwnersClick, onBlogClick, onAboutClick, onPrivacyClick, onTermsClick, onContactClick }) => {
