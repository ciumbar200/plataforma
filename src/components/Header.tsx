...
const Header: React.FC<HeaderProps> = ({ onLoginClick, onHomeClick, onOwnersClick, pageContext, hideAuthActions = false }) => {
                    ...
                    {!hideAuthActions && (
                        <div className="flex items-center gap-4">
                            <button
                                ...
                                className="text-sm font-medium text-white/80 hover:text-white transition-colors px-3 py-2 rounded-full hover:bg-white/10 hidden sm:block"
                            >
                            {switchText}
                            </button>
                            <button
